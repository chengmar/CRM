...
<main id="main-content" class="site-main">
	<header class="page-header page-header--compact">
		<div class="site-shell">
			...
			<p class="eyebrow"><?php esc_html_e( 'Application', 'demo_manufacturer' ); ?></p>
			<h1><?php echo esc_html( $term_name ); ?></h1>
			<?php if ( term_description() ) : ?>
				<div class="page-header__lede"><?php echo wp_kses_post( term_description() ); ?></div>
			<?php else : ?>
				<p class="page-header__lede"><?php esc_html_e( 'Review current products and planning guidance, then confirm the selected item against the approved requirements.', 'demo_manufacturer' ); ?></p>
			<?php endif; ?>
		</div>
	</header>
